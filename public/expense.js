document.addEventListener('DOMContentLoaded', function () {
    const elements = {
      ...
      const fetchExpenses = async () => {
        ...
        try {
          const response = await axios.get(`http://184.73.149.88:3000/expenses?page=${currentPage}&limit=${rowsPerPage}`, {
      ...
      const handleAddOrUpdateExpense = async () => {
        ...
        try {
          let response;
          if (editingIndex === -1) {
            response = await axios.post('http://184.73.149.88:3000/expenses', newExpense, {
              headers: { Authorization: token },
            });
            ...
            response = await axios.put(`http://184.73.149.88:3000/expenses/${id}`, newExpense, {
              headers: { Authorization: token },
            });
      ...
      const handleDeleteExpense = async (id) => {
        ...
        try {
          const response = await axios.delete(`http://184.73.149.88:3000/expenses/${id}`, {
            headers: { Authorization: token },
          });
      ...
      async function handlePurchase(e) {
        ...
        try {
          const response = await axios.get('http://184.73.149.88:3000/premium/premiummembership', {
            headers: { Authorization: token },
          });
            ...
            handler: async function (response) {
              ...
              try {
                const verification = await axios.post(
                  'http://184.73.149.88:3000/premium/updatetransactionstatus',
                  payment,
                  { headers: { Authorization: token } }
                );
      ...
      const handleDownloadExpenses = async () => {
        ...
        try {
          const response = await axios.get('http://184.73.149.88:3000/expenses/download', {
            headers: { Authorization: token },
            responseType: 'blob',  
          });
      ...
      const fetchDownload = async () => {
        ...
        try {
          const response = await axios.get('http://184.73.149.88:3000/expenses/getdownload', {
            headers: { Authorization: token },
          });
